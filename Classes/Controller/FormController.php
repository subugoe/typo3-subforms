...
class FormController extends ActionController
{
    ...
    public function createAction($values)
    {
        ...
        if (self::sendEmail($values)) {
            $this->addFlashMessage(LocalizationUtility::translate($lowerCaseModel . '.thankYou', self::extKey), '',
                FlashMessage::OK);
            $this->addFlashMessage(LocalizationUtility::translate($lowerCaseModel . '.thankYouText', self::extKey), '',
                FlashMessage::OK);
        } else {
            $this->addFlashMessage(LocalizationUtility::translate('tx_subforms.error', self::extKey), '',
                FlashMessage::ERROR);
        }
