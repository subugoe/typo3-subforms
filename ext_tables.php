...
\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerPlugin('Subugoe.' . $_EXTKEY, 'Buecherwunsch', 'Formular Buecherwunsch');

// Feedback Plugin
\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerPlugin('Subugoe.' . $_EXTKEY, 'Feedback', 'Formular Feedback');

// Feedback Plugin
\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerPlugin('Subugoe.' . $_EXTKEY, 'Fragdiesub', 'Formular Frag die Sub');
